...
CURATED = [
 ...
 # צילום של דוד מהטלפון, בשקיעה אמיתית. 1200px ולא 6144 כמו הצילומים
 # המקצועיים, אבל זו התמונה שהוא ובעלת המקצוע בחרו במפורש, והשמש על
 # קו הים היא משהו שאף אחד מצילומי הרחפן לא תפס.
 ("jacuzzi-sunset",    "david/jacuzzi-sunset-wide.jpg", "הג׳קוזי מול השקיעה"),
 ...
 # _DSC9541 ו-_DSC9546 הם אותה פינה בדיוק, בשתי גרסאות שמיים שהצלם
 # הרכיב. הראשונה כתומה ונראית מלאכותית, והשנייה בהירה וטבעית. דוד
 # הראה את שתיהן זו לצד זו וביקש את הבהירה, ולכן הכתומה יורדת.
