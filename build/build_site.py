...
PHONE_INTL = "972545004139"
PHONE_DISP = "054-5004139"
ADDRESS = "גבעת אולגה"
...
# ------------------------------------------------------------------ תוכן
SEGMENTS = [
    ("garden-lawn",     "לינה",       "משפחות וקבוצות", "עד 17 אורחים ב-4 חדרי שינה ו-2.5 חדרי רחצה."),
    ...
    ("living-dining",   "עסקים",      "ימי גיבוש",      "יום שלם לצוות מחוץ למשרד: חצר, בריכה, חדר משחקים ומטבח מלא."),
    ("night-lounge",    "חוגגים",     "רווקים ורווקות", "ג׳קוזי, מערכת סראונד, ותאורת לילה בחצר ובבריכה."),
    ("jacuzzi-dusk",    "זוגות",      "סוף שבוע זוגי",  "ג׳קוזי מול הים ובריכה פרטית. הווילה נמסרת כולה גם לזוג אחד."),
]
...
FAQ = [
    ("איך מזמינים?",
     ...
     "או מתקשרים. דוד או ולריה חוזרים אליכם עם אישור לתאריך ועם המחיר הסופי."),
    ("מה כלול במחיר הלינה?",
     "הווילה כולה לעד 10 אורחים: 4 חדרי שינה, הבריכה, הג׳קוזי, החצר, המטבח וחדר "
     "המשחקים. אין שיתוף עם אורחים אחרים. מעל 10 אורחים יש תוספת לאדם."),
    ("הבריכה פעילה כל השנה?",
     "כן. מחוממת בחודשי החורף ומקוררת בימי הקיץ החמים."),
    ("אפשר לקיים אירוע?",
     "כן, עד 50 איש. אירועים מתומחרים בנפרד מלינה ובתיאום מראש, כי המחיר תלוי "
     "באופי האירוע, בשעות ובתוספות. השאירו פרטים ותקבלו הצעה."),
    ("יש אפשרות להתארגנות כלה?",
     "כן. חללים מרווחים, אור טבעי, מראות גוף ופינות צילום, והמתחם סמוך לגני "
     "האירועים בשרון. להתארגנות כלה יש מחירים מיוחדים."),
    ("לוח הזמינות באתר מדויק?",
     "הלוח נשלף מלוח השנה של הווילה ומתעדכן ממנו. האישור הסופי לתאריך נעשה "
     "מול דוד או ולריה לפני התשלום."),
    ("מה המרחק מהים?",
     "הטיילת של גבעת אולגה מתחילה כמה רחובות מהווילה. מכמורת 10 דקות נסיעה, "
     "קיסריה 12."),
    ("מה שעות הצ׳ק־אין והצ׳ק־אאוט?",
     "הכניסה והיציאה נקבעות מראש מול דוד או ולריה, והכניסה עצמאית בכספת "
     "מפתחות."),
    ("האם המקום שומר שבת?",
...
<section class="hero" id="top">
  ...
  <div class="hero-in">
    ...
    <p class="lead">בריכה מחוממת בחורף ומקוררת בקיץ, ג׳קוזי על המרפסת העליונה מול הים,
       וחצר שמקיפה את הבית. הטיילת של גבעת אולגה מתחילה כמה רחובות מכאן.</p>

    <form class="herobook" id="herobook">
      <!-- שדה תאריך מקורי פותח את בורר מערכת ההפעלה: קטן, לא מכיר את
           הזמינות, ושונה בכל דפדפן. הלוח בסקציית ההזמנה כבר עושה את
           זה טוב יותר, ולכן כאן יש כפתור שמוביל אליו ומציג את הבחירה. -->
      <button type="button" class="f fdate" id="hbDates">
        <span class="flb">תאריכים</span>
        <span class="val" id="hbDatesVal">בחירה בלוח</span>
      </button>
    ...
    <!-- קודם היו כאן ארבעה מספרים גדולים עם כיתוב מתחתם. מספר מבודד
         לא אומר כלום עד שקוראים את השורה שמתחתיו, והדירוג חזר על מה
         שכתוב בפס האמון ממש מתחת. עכשיו המספר יושב בתוך המשפט. -->
    <ul class="hero-facts">
      <li><b class="num">4</b> חדרי שינה</li>
      <li><b class="num">2.5</b> חדרי רחצה</li>
      <li>עד <b class="num">17</b> ללינה</li>
      <li>עד <b class="num">50</b> באירוע</li>
    </ul>
  </div>
...
<div class="trust">
  <div class="trust-in">
    ...
    <span><b>מארח מצטיין</b> ב-Airbnb</span>
  </div>
</div>
""")
...
<section id="about">
  <div class="wrap">
    <div class="sec-head narrow rv">
      ...
      <h2>הווילה נמסרת לקבוצה אחת בכל פעם</h2>
      <p class="lead">4 חדרי שינה, 2.5 חדרי רחצה, בריכה חיצונית, ג׳קוזי על המרפסת
        העליונה וחצר שמקיפה את הבית מכל הצדדים.</p>
      <p>הבריכה מחוממת בחודשי החורף ומקוררת בימי הקיץ החמים. הכניסה עצמאית
        בכספת מפתחות, החניה בתוך המתחם, והמקום מותאם לשמירת שבת.</p>
    </div>
    <div class="split">
...
<section class="reels" id="reels">
  <div class="wrap"><div class="day-head rv">
    <div class="sec-head narrow" style="margin-bottom:0">
      ...
      <h2>המקום בתנועה</h2>
      <p class="lead">שישה סרטונים קצרים שצולמו במתחם. לחצו על אחד כדי
         להפעיל אותו.</p></div>
    <div class="day-nav">
  ...
  <p class="dayhint">גללו לצדדים לשאר הסרטונים</p>
    ...
    spaces = [
        ("pool-tree-day", "הבריכה", "בריכה שלא נסגרת בחורף",
         "מחוממת בחודשים הקרים ומקוררת בימי החום. מגודרת, עם דק עץ, מקלחת חוץ "
         "ועץ זית שנותן צל אחר הצהריים.", False),
        ("jacuzzi-sunset", "הקומה העליונה", "ג׳קוזי במרפסת שפונה לים",
         "ג׳קוזי זרמים ו-2 מיטות שיזוף על המרפסת העליונה. המרפסת פונה מערבה, "
         "והשמש נכנסת לים בדיוק מולה.", True),
        ("garden-sculpt", "החצר", "חצר שמקיפה את הבית",
         "מדשאה, פינת ברביקיו, ערסל, כורסאות תלויות ופינות ישיבה. "
         "בערב נדלקת תאורת הגינה.", False),
        ("living-open", "פנים הבית", "הסלון שנפתח אל החצר",
         "סלון ופינת אוכל שנפתחים ברוחב מלא אל הדק. מטבח עם מכונת אספרסו, "
         "מדיח ותנור, ו-4 חדרי שינה עם מזרנים אורתופדיים.", True),
        # נשאר game-snooker: מכל צילומי הפנאי בספרייה זה היחיד שהנושא
        # בו ברור והחדר מואר. game-hockey רחב יותר אבל שליש ממנו תקרת
        # בטון אפורה, ו-game-pingpong אפרורי. זו חוסר בצילום, לא בבחירה.
        ("game-snooker", "פנאי", "מה עושים כשלא שוחים",
         "שולחן סנוקר, פינג פונג והוקי אוויר. בסלון מערכת סראונד וטלוויזיה "
         "65 אינץ׳ עם נטפליקס.", False),
    ]
    ...
    A("""<div class="wrap"><div class="sec-head narrow rv"><p class="eyebrow">המתחם</p>
         ...
         <p class="lead">הבריכה, המרפסת העליונה, החצר, פנים הבית וחדר
            המשחקים.</p></div></div>""")
    A('<div class="rows">')
    ...
    A("""<div class="sec-head narrow rv"><p class="eyebrow">למי זה מתאים</p>
         ...
         <p class="lead">לכל אחד מהם תמחור והיערכות אחרת. לחצו על מה
            שמתאים לכם.</p></div>""")
...
<section id="services" style="background:var(--paper-2)"><div class="wrap">
  <div class="sec-head narrow rv">
    ...
    <p class="lead">המתחם עצמו כלול במחיר. את אלה מזמינים מראש, והם מגיעים
       אליכם למקום. כל תוספת מתומחרת בנפרד.</p>
  </div>
  <div class="svcs rv stag">
    ...
    <article class="svc" data-service="מוזיקה חיה" role="button" tabindex="0"
      ...
      <div class="svc-in"><h3>מוזיקה חיה</h3>
        <p>הרכב אקוסטי שמנגן בחצר, לאירוע או לערב שקט
           יותר.</p>
        <span class="svc-go">לבקשת הצעה</span></div>
    </article>
    <article class="svc" data-service="עיצוב ואווירה" role="button" tabindex="0"
      ...
      <div class="svc-in"><h3>עיצוב ואווירה</h3>
        <p>נרות, כלים וסידור שולחן, מותאמים לאופי האירוע ולמספר
           האורחים.</p>
        <span class="svc-go">לבקשת הצעה</span></div>
    </article>
  </div>
  <p class="svc-note rv">אין מחירון קבוע לתוספות. כתבו לנו מה מעניין
     אתכם ותקבלו הצעה.</p>
</div></section>""")
  ...
  <div class="scrub-pin">
    ...
    <div class="scrub-txt">
      <div class="step" data-at="0.06">
        ...
        <p>הטיילת, החוף והמסעדות שלצידו.</p>
      </div>
      <div class="step" data-at="0.42">
        <p class="eyebrow">המיקום</p>
        <h2>בין מכמורת לקיסריה</h2>
        <p>10 דקות למכמורת, 12 לקיסריה.</p>
      </div>
      <div class="step" data-at="0.78">
        <p class="eyebrow">המתחם</p>
        <h2>וילה אחת בתוך כל זה</h2>
        <p>רחוב שקט, חצר מגודרת, וקבוצה אחת בכל פעם.</p>
      </div>
    </div>
    ...
    DAYPANELS = [
        ("garden-swing", "07:00", "בוקר",   "קפה בחצר לפני שכולם קמים. השמש עוד נמוכה והמדשאה עדיין קרירה."),
        ("pool-deck",    "13:00", "צהריים", "הבריכה בשיאה. מקלחת חוץ, דק חם וצל של עץ זית."),
        ("jacuzzi-dusk", "19:00", "שקיעה",  "עולים לקומה העליונה. הג׳קוזי דלוק והשמש נכנסת לים."),
        ("night-lounge", "23:00", "לילה",   "תאורת הגינה נדלקת, הבריכה מוארת, והמוזיקה נשארת בחצר."),
    ]
    ...
    A("""<div class="wrap"><div class="day-head rv">
         <div class="sec-head narrow" style="margin-bottom:0">
           ...
           <p class="lead">אותו מתחם בארבע שעות שונות של היום.</p></div>
         <div class="day-nav">
    ...
    A('</div>')
    A('<p class="dayhint">גללו לצדדים לשאר השעות</p>')
    A('</section>')
...
<section class="band rv" style="padding:0">
  ...
  <div class="band-in">
    ...
    <p>יש כאן וילה אחת, וכל תאריך נמסר פעם אחת. הלוח מראה מה פנוי כרגע.</p>
    ...
    A("""<div class="sec-head narrow rv"><p class="eyebrow">מה יש במקום</p>
         <h2>הרשימה המלאה</h2>
         <p class="lead">כל מה שברשימה נמצא בתוך הגדר וכלול
            במחיר.</p></div>""")
    ...
    A(f"""<div class="sec-head narrow rv"><p class="eyebrow">גלריה</p>
         ...
         <p class="lead">כולן צולמו במתחם. לחיצה על תמונה פותחת
            אותה בגודל מלא.</p></div>""")
    ...
    A(f"""<div class="sec-head narrow rv"><p class="eyebrow">אורחים</p>
         ...
         <p class="lead">9 ב-<a href="{URL_AIRBNB}" target="_blank" rel="noopener">Airbnb</a>,
            ...
            כל קישור מוביל לביקורת במקור.</p></div>""")
    ...
    A("""<div class="sec-head narrow rv"><p class="eyebrow">מחירים</p>
         ...
         <p class="lead">הבריכה, הג׳קוזי, החצר וחדר המשחקים כלולים במחיר.
            המחירים בטבלה הם לעד 10 אורחים; אירועים, חגים וחופשות מתומחרים
            בנפרד.</p></div>""")
    A(f"""<div class="split rv" style="align-items:start">
      <div>
        ...
        <p class="muted" style="font-size:.88rem;margin-top:20px">
          להתארגנות כלה יש מחירים מיוחדים. המחיר הסופי מאושר מול דוד
          או ולריה לפני התשלום.</p>
      </div>
...
<section class="book" id="book"><div class="wrap">
  <div class="sec-head narrow rv">
    ...
    <p class="lead">בחרו בלוח תאריך כניסה ואחריו תאריך יציאה. המחיר
       יופיע כאן למטה.</p>
  </div>""")
  ...
  <div class="bookgrid rv">
    <form id="bookform" autocomplete="on" novalidate>
      ...
      <div class="field"><label for="nt">הערות<span class="sh">לא חובה</span></label>
        <textarea id="nt" rows="2" placeholder="שעת הגעה, אירוע מיוחד, בקשה מיוחדת"></textarea></div>
      <button class="btn" type="submit" id="send">שליחת בקשה בוואטסאפ</button>
      <p class="formerr" id="formErr" role="alert"></p>
      <p class="callalt">מעדיפים לדבר? <a href="tel:+{PHONE_INTL}" class="num">{PHONE_DISP}</a><span class="sh">הבקשה לא מחייבת אתכם</span></p>
    </form>
    <div class="quote" id="quote" aria-live="polite">
      <div class="empty" id="qEmpty">בחרו תאריכים בלוח, והמחיר יופיע כאן</div>
...
<section id="location"><div class="wrap">
  <div class="split rv">
    <div>
      ...
      <h2 style="margin-bottom:18px">גבעת אולגה, בין מכמורת לקיסריה</h2>
      ...
      <table class="ptable" style="margin-top:22px">
        ...
        <tr><td>מכמורת</td><td class="num">10 דק׳</td></tr>
...
<section id="faq" style="background:var(--paper-2)"><div class="wrap narrow">
  <div class="sec-head rv"><p class="eyebrow">שאלות</p><h2>שאלות נפוצות</h2></div>
  <div class="faq rv">
  ...
  <div class="wrap">
    <div class="fgrid">
      <div>
        ...
        <p style="max-width:34ch">וילה פרטית אחת בגבעת אולגה, חדרה.
           בריכה, ג׳קוזי, חצר, ועד 17 אורחים ללינה.</p>
      </div>
      <div>
        <h3>יצירת קשר</h3>
        <ul>
